...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            ["foo"],
            ["foo_stubs"],
            id="type-stubs__matches_without_-stubs_suffix",
        ),
        pytest.param(
            "foo-stubs",
            ["foo-stubs"],
        ...
        pytest.param(
            "foobar",
            ["other_module", "another", "foobar"],
            ["other_module", "another"],
            id="find_one_match_among_many_nonmatches",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            ["requests"],
            ["types_requests"],
            id="name_with_stubs_suffix__matches_name_without_stubs_suffix",
        ),
        pytest.param(
            "foobar",
            {"foo", "bar", "baz"},
            ["other_module", "another", "bar"],
            ["other_module", "another", "foobar"],
            id="find_one_match_among_many_nonmatches",
        ),
    ],
